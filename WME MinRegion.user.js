    ...
    function MinRegion_init() {
        ...
        function onSendRequest() {
            ...
            if (email && validateEmail(email)) {
                ...
                alert('MinRegion:\nЩоб мати можливість надсилати запити, валідна Email адреса має бути додана у налаштуваннях скрипта.');
            }
        }
                ...
                as.forEach(function (elem) {
                    ...
                    if (obj && obj.value) {
                        elem.onclick = function () {
                            ...
                            var url = mrUrl;
                            if (arr.length == 3) {
                                url += "/api/format?doct_id=layer_object_info&layer=7376316114267884&view=site&x=" + arr[0] + "&y=" + arr[1] + "&index=" + arr[2] + "&data=geom,name_ua&method=feature_ir._info_object&wrap=map_obj_info_wrap_ato";
                            }
                            else {
